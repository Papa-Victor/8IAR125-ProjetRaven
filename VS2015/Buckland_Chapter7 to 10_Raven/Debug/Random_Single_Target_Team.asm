; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	C:\Users\Utilisateur\Documents\GitHub\8IAR125-ProjetRaven\VS2015\Buckland_Chapter7 to 10_Raven\Random_Single_Target_Team.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 39   : 	bot->SetTargetControl(false);

	push	0
	mov	ecx, DWORD PTR _bot$[ebp]
	call	?SetTargetControl@Raven_Bot@@QAEX_N@Z	; Raven_Bot::SetTargetControl

; 40   : 	if (bot == m_currentTarget || m_currentTarget == NULL) {
