...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG171712 DB	'<Goal_Think::Arbitrate>: no evaluator selected', 00H
	ORG $+1
$SG171713 DB	'c', 00H, ':', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H
...
$SG171714 DB	'M', 00H, 'o', 00H, 's', 00H, 't', 00H, 'D', 00H, 'e', 00H
...
; 48   :   void Terminate(){m_iStatus = completed;}
...
; 34   :                int        item):Goal_Composite<Raven_Bot>(pBot,
...
; 35   :                                                    ItemTypeToGoalType(item)),
; 36   :                                 m_iItemToGet(item),

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _item$[ebp]
	mov	DWORD PTR [eax+28], ecx

; 37   :                                 m_pGiverTrigger(0),

	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+32], 0

; 38   :                                 m_bFollowingPath(false)
...
; 116  :   assert(MostDesirable && "<Goal_Think::Arbitrate>: no evaluator selected");
	...
	mov	ecx, OFFSET $SG171712
	test	ecx, ecx
	jne	SHORT $LN8@Arbitrate
$LN7@Arbitrate:
	push	116					; 00000074H
	push	OFFSET $SG171713
	push	OFFSET $SG171714
	call	__wassert
	add	esp, 12					; 0000000cH
$LN8@Arbitrate:
